...
class ADestructibleWoodenBox : public AActor
{
    DECLARE_CLASS(ADestructibleWoodenBox, AActor)

public:
    ADestructibleWoodenBox();
    virtual ~ADestructibleWoodenBox() override = default;
    ...
    void TriggerDestruction(FVector HitLocation, FVector ImpulseDirection);
